...
export declare class HelixChannelApi extends BaseApi {
     ...
     * @expandParams
     */
    getChannelFollowers(broadcaster: UserIdResolvable, moderator: UserIdResolvable, user?: UserIdResolvable, pagination?: HelixForwardPagination): Promise<HelixPaginatedResult<HelixChannelFollower>>;
    /**
